...
public class Socio extends Usuario{
	...
	public Socio(String nickname, String nombre, String apellido, String email, Date fechaNac,byte[] imagen, String passward, String Url) {
	...
	public DtUsuario getDtUsuario() {
		...
		return new DtSocio(this.getNickname(), this.getNombre(), this.getApellido(), this.getEmail(), this.getFechaNac(), this.getImagen(), this.getPassward(), this.getUrl(), reguis);
