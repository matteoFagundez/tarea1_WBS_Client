...
public class AltaUsuario extends JInternalFrame {
	...
	public AltaUsuario(IControlador iC) {
							...
							if(!txtDesc.getText().isEmpty() || rbtnSocio.isSelected()) {
								try {
							    	...
							    	if(rbtnProfe.isSelected()) {
							  	    	...
							  	    	dtusuario=new DtProfesor(nick, nombre, apellido, email, fech, null, passward, Url, desc, bio, sitweb, null); 
							    		...
							    		dtusuario=new DtSocio(nick, nombre, apellido, email, fech, null,passward, Url, null);
		...
		JLabel Url = new JLabel("Imagen:");
		Url.setFont(new Font("Tahoma", Font.BOLD, 14));
		Url.setBounds(53, 385, 95, 19);
		contentPane.add(Url);
		
		textUrl = new JTextField();
		textUrl.setColumns(10);
		textUrl.setBounds(121, 384, 220, 20);
