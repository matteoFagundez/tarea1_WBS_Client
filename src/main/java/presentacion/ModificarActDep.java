	...
	public ModificarActDep(IControlador iC) {
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {	
				...
				String dur = txFDuracion.getText();
				String cos = txFCosto.getText();
				String fech = txFfecha.getText();
				String dura = txFDuracion.getText();
				String ins = txFInt.getText();
									
				if(!nom.isEmpty() && !dur.isEmpty() && !cos.isEmpty() && !fech.isEmpty() && !dura.isEmpty() && !ins.isEmpty()) {
					try {
