...
public interface IControlador {
	...
	void modificarUsuario(String nick, String nombre, String apellido, Date fechaN, String passward, String Url);
	...
	public boolean existeRegistro(String nombreC, String socio);
